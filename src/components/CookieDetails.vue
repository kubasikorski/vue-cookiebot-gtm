    ...
    <div class="cookiebanner__details__inner">
      <div class="cookiebanner__details__preferences">
        <fieldset class="cookiebanner__details__preferences__options">
          ...
          <CookieType v-model="approvals.necessary" inputValue="necessary" :disabled="true"  :content="content.types.a" />
          <CookieType v-model="approvals.preferences" inputValue="preferences" :disabled="false" :content="content.types.b" />
          <CookieType v-model="approvals.statistics" inputValue="statistics" :disabled="false"  :content="content.types.c" />
          <CookieType v-model="approvals.marketing" inputValue="marketing" :disabled="false"  :content="content.types.d" />
        </fieldset>
        <div class="cookiebanner__details__preferences__buttons">
          <button v-on:click="$emit('submitChoosen', approvals)" id="CybotCookiebotDialogBodyLevelButtonLevelOptinAllowallSelection"
